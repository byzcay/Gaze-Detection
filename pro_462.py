...
#We import the libraries which we will use in this project.
...
videos = glob.glob("C:/Users/90544/Desktop/462-proje/462-proje/videos/focus*.mp4") #videoların nerede bulundugu
#print(len(videos))
countIndex = 0
...
for i in videos:
    ...
    def getFrame(sec):
        ...
        if hasFrames:
            os.chdir("C:/Users/90544/Desktop/462-proje/462-proje/videos/focus")
    ...
    with mp_face_mesh.FaceMesh(
        ...
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                #We use coloring to show the coordinates of the right and left eyes and iris.
                ...
                if key ==ord('q'):
                    break
    test.append(array)
    result.loc[len(result)] = [i.replace('C:/Users/90544/Desktop/462-proje/462-proje/videos/focus',''),array]

cap.release()
cv.destroyAllWindows()


os.chdir("../../") #I'm going up to 2 folders. to print the Excel file to the main folder.
#We print the final version of the data to the excel file
